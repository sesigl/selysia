              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-purple-600 mb-2">
                    Publish to all popular platforms
                  </div>
                  <h3 className="h3 mb-3">Say hello to automation</h3>
                  <p className="text-xl text-gray-400 mb-4">
                    Social media platforms a continuously evolving and different
                    in its core. We give you all the tools you need to publish
                    your content in the ideal format to many different platforms
                    in one take.
                  </p>
                  ...
                  <div className="flex items-start mt-8">
                    ...
                    <div>
                      <blockquote className="text-gray-400 italic m-0 mb-3">
                        &quot;Stop focusing on only one platform. Use automation
                        to create content for multiple platforms to increase
                        your reach by 10x&quot;.
                      </blockquote>
                      <div className="text-gray-700 font-medium">
                        ...
                        -{" "}
                        <span className="text-purple-600 transition duration-150 ease-in-out">
                          Developer
                        </span>
                      </div>
                    </div>
